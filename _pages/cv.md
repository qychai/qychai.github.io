...
======
- (In)Credible Development RCTs: False Discoveries, Low Power, and a Solution</a> (with [Kevin Lang](https://sites.bu.edu/kevinlang/) and [Liang Zhong](https://samzl1.github.io)) <br/>
<a href="#/" onclick="visib('abstract8')">Abstract</a> 
<div id='abstract8' style="display: none; text-align: justify; line-height: 1.2" >
We study statistically significant findings from development RCTs published in leading economics journals. Given claimed power of 0.8, the t-statistics among rejected nulls should center near 2.8. Actual t-statistics peak well below 2.8, but above values associated with p-hacking. This suggests many RCTs are underpowered or test true nulls that should not be rejected. Using our hand-collected sample, we model the distribution of principal-hypothesis t-statistics. The estimates imply that about 30% of the published principal nulls are false discoveries and that average power against nonzero effects is 0.4. We then compare remedies. Doubling sample sizes would have little effect on the false discovery rate. Lowering the significance threshold to .005, as suggested by Benjamin et al. (2018), is somewhat more effective but sharply reduces discoveries. Instead, we argue for more targeted replication, focusing on studies with prior t-statistics in an intermediate range.</div>
<p id="special-text">Presentations: AFE(2026)</p>
